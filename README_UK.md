...
**Легка заміна Docker Swarm для малих та середніх кластерів з сумісністю Kubernetes API.**

Podman Swarm створений як простий та зручний оркестратор контейнерів, який:
- **Розуміє Kubernetes маніфести** (Deployment, Service, Ingress)
- **Надає простоту Docker Swarm** та легкість розгортання
- **Чудово працює для малих та середніх кластерів** (5-50 нод)
- **Всі ноди рівноправні** - справжня peer-to-peer архітектура, без master нод
- **Безпека за замовчуванням** - мінімальні привілеї, rootless режим, безпечний з коробки
- **Не є повноцінною заміною Kubernetes** - сфокусована простота
- **Тільки основні функції** - без непотрібної складності
